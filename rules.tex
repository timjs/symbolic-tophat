...
\newrule{SH-Next}
  {t_1,\sigma \handle{} \overline{t_1',\sigma',\highlight{i,\phi}} \Quad
  e_2\ v_1,\sigma \normalise \overline{t_2,\sigma',\highlight{\phi}}}
  {t_1 \Next e_2,\sigma \handle{} \highlight{\overline{t_1' \Next e_2,\sigma',i,\phi}\cup\overline{t_2,\sigma',s,\phi \land s=\Continue}}}
...
\newrule{SH-And}
  ...
  {t_1 \And t_2,\sigma \handle{} \highlight{\overline{t_1' \And t_2,\sigma',\First i,\phi}\cup \overline{t_1 \And t_2',\sigma'',\Second i,\phi}}}

\newrule{SH-Or}
  {t_1,\sigma \handle{} \overline{t_1',\sigma',\highlight{i,\phi_1}}\Quad
  t_2,\sigma \handle{} \overline{t_2',\sigma'',\highlight{i,\phi_2} }}
  {t_1 \Or t_2,\sigma \handle{} \highlight{\overline{t_1' \Or t_2,\sigma',\First i,\phi_1}\cup\overline{t_1 \Or t_2',\sigma'',\Second i,\phi_2}}}
...
\newrule{SH-Pick}
  {e_1,\sigma \normalise \overline{t_1,\highlight{\sigma_1,\phi_1}} \Quad
   e_2,\sigma \normalise \overline{t_2,\highlight{\sigma_2,\phi_1}}}
  {e_1 \Xor e_2,\sigma \handle{} \highlight{\overline{t_1,\sigma_1,s,\phi_1 \land s=\Left}\cup\overline{t_2,\sigma_2,s,\phi_2 \land s=\Right}}}
