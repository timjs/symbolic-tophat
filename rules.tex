...
\newrule{Sym-E-App}
  {e_1,\sigma\eval \lambda x:\tau.e_1',\sigma',\phi_1 \Quad
   ...
   e_1'[x\mapsto v_2],\sigma''\eval v_1,\sigma''',\phi_3 \Quad
   \text{SAT } \phi_1 \land \phi_2 \land \phi_3}
...
\newrule{Sym-E-IfTrue}
  {e_1,\sigma\eval v_1,\sigma',\phi_1 \Quad
   e_2,\sigma'\eval v_2,\sigma'',\phi_2 \Quad
   \text{SAT } \phi_1 \land \phi_2 \land v_1}
  {\If{e_1}{e_2}{e_3},\sigma\eval v_2,\sigma'',\phi_1 \land \phi_2 \land v_1}

\newrule{Sym-E-IfFalse}
  {e_1,\sigma\eval v_1,\sigma',\phi_1 \Quad
   e_3,\sigma'\eval v_3,\sigma'',\phi_3 \Quad
   \text{SAT } \phi_1 \land \phi_2 \land \lnot v_1}
...
\newrule{Sym-E-And}
  {e_1 ,\sigma\eval t_1 ,\sigma',\phi_1 \Quad
   e_2 ,\sigma'\eval t_2,\sigma'',\phi_2 \Quad
   \text{SAT} \phi_1 \land \phi_2}
