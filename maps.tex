...
\newmacro{O-Failing}{
  \begin{function}
    ...
    \Failing(e_1 \Xor e_2,\sigma)  &=& \bigvee \left( \set{\Failing(t_1,\sigma_1') \mid e_1, \sigma \normalise \overline{t_1,\sigma_1'}}\ \cup \\
                          & & \phantom{\bigvee \left(} \set{\Failing(t_2,\sigma_2') \mid e_2, \sigma \normalise \overline{t_2,\sigma_2'}} \right)
