...
\newmacro{O-Failing}{
  \begin{function}
    ...
    \Failing(e_1 \Xor e_2,\sigma)  &=& \highlight{\bigvee \Big( \set{\Failing(t_1,\sigma_1') \mid e_1, \sigma \normalise \overline{t_1,\sigma_1'}}\ \cup} \\
                          & & \highlight{\phantom{\bigvee \Big(}\set{\Failing(t_2,\sigma_2') \mid e_2, \sigma \normalise \overline{t_2,\sigma_2'}} \Big)} \\
