...
\newmacro{O-Inputs}{
  \begin{function}
    ...
    \Inputs(t_1 \Next e_2,s)       &=& \Inputs(t_1,s) \cup \set{\Continue \mid \Value(t_1, s) = v_1 \land e_2\ v_1, s \symnormalise t_2, s' \land \lnot\Failing(t_2, s')} \\
    ...
    \Inputs(e_1 \Xor e_2,s)        &=& \set{\Left \mid e_1, s \symnormalise t_1, s' \land \lnot\Failing(t_1, s')} \cup \set{\Right \mid e_2, s \symnormalise t_2, s' \land \lnot\Failing(t_2, s')}
