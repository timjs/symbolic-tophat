...
\newrule{H-FirstAnd}
  {t_1,\sigma \xrightarrow[]{i} \bar{t_1'},\bar{\sigma'}}
  {t_1 \And t_2,\sigma \xrightarrow[]{\First i} \bar{t_1'} \And t_2,\bar{\sigma'}}

\newrule{H-SecondAnd}
  {t_2,\sigma \xrightarrow[]{i} \bar{t_2'},\bar{\sigma'}}
  {t_1 \And t_2,\sigma \xrightarrow[]{\Second i} t_1 \And \bar{t_2'},\bar{\sigma'}}


\newrule{H-FirstOr}
  {t_1,\sigma \xrightarrow[]{i} \bar{t_1'},\bar{\sigma'}}
  {t_1 \Or t_2,\sigma \xrightarrow[]{\First i} \bar{t_1'} \Or t_2,\bar{\sigma'}}

\newrule{H-SecondOr}
  {t_2,\sigma \xrightarrow[]{i} \bar{t_2'},\bar{\sigma'} }
  {t_1 \Or t_2,\sigma \xrightarrow[]{\Second i} t_1 \Or \bar{t_2'},\bar{sigma'}}
...
\newrule{I-Handle}
  {t,\sigma \xrightarrow[]{i} t',\sigma',\phi_1 \Quad
