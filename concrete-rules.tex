...
\newmacro{RelationE}
  {e,\hat{\sigma} \hat{\eval} v,\hat{\sigma}'}
...
\newmacro{RelationS}
  {t,\hat{\sigma} \hat{\stride} t',\hat{\sigma}'}
...
\newmacro{RelationH}
  {t,\hat{\sigma} \hat{\handle{j}} t',\hat{\sigma}'}
...
\newmacro{RelationI}
  {\hat{t},\hat{\sigma} \hat{\drive{j}} \hat{t}',\hat{\sigma}'}
