...
\newrule{H-PassThen}
  {t_1,\hat\sigma \xrightarrow[]{j} \hat{t_1'},\hat\sigma'}
  {t_1 \Then e_2,\hat\sigma \xrightarrow[]{j} \hat{t_1'} \Then e_2,\hat\sigma'}

\newrule{H-PassNext}
  {t_1,\hat\sigma \xrightarrow[]{j} \hat{t_1'},\hat\sigma'}
  {t_1 \Next e_2,\hat\sigma \xrightarrow[]{j} \hat{t_1'} \Next e_2,\hat\sigma'}

\newrule{H-Next}
  {e_2\ \hat{v_1},\hat\sigma \hat{\normalise} \hat{t_2},\hat{\sigma}'}
  {t_1 \Next e_2,\hat\sigma \xrightarrow[]{\Continue} \hat{t_2},\hat{\sigma}'}
  [\Value{(t_1,\hat\sigma)} = \hat{v_1} \land \neg\Failing{(\hat{t_2},\hat{\sigma}')}]


\newrule{H-FirstAnd}
  {t_1,\hat\sigma \xrightarrow[]{j} \hat{t_1}',\hat{\sigma}'}
  {t_1 \And t_2,\hat\sigma \xrightarrow[]{\First j} \hat{t_1}' \And t_2,\hat{\sigma}'}

\newrule{H-SecondAnd}
  {t_2,\hat\sigma \xrightarrow[]{j} \hat{t_2}',\hat{\sigma}'}
  {t_1 \And t_2,\hat\sigma \xrightarrow[]{\Second j} t_1 \And \hat{t_2}',\hat{\sigma}'}


\newrule{H-FirstOr}
  {t_1,\hat\sigma \xrightarrow[]{j} \hat{t_1}',\hat{\sigma}'}
  {t_1 \Or t_2,\hat\sigma \xrightarrow[]{\First j} \hat{t_1}' \Or t_2,\hat{\sigma}'}

\newrule{H-SecondOr}
  {t_2,\hat\sigma \xrightarrow[]{j} \hat{t_2}',\hat{\sigma}' }
  {t_1 \Or t_2,\hat\sigma \xrightarrow[]{\Second j} t_1 \Or \hat{t_2}',\hat{\sigma}'}


\newrule{H-PickLeft}
  {e_1,\hat\sigma \hat\normalise \hat{t_1},\hat{\sigma}'}
  {e_1 \Xor e_2,\hat\sigma \xrightarrow[]{\Left} \hat{t_1},\hat{\sigma}'}
  [\neg\Failing(\hat{t_1},\hat{\sigma}')]

\newrule{H-PickRight}
  {e_2,\hat\sigma \hat{\normalise} \hat{t_2},\hat{\sigma}'}
  {e_1 \Xor e_2,\hat\sigma \xrightarrow[]{\Right} \hat{t_2},\hat{\sigma}'}
  [\neg\Failing(\hat{t_2},\hat{\sigma}')]
