...
\newrule{T-ListEmpty}
  { }
  {\Gamma,\Sigma\infers [\ ]_\beta : \text{List}\beta}

\newrule{T-ListCons}
  {\Gamma,\Sigma\infers e_1:\beta \Quad
   \Gamma,\Sigma\infers e_2:\text{List }\beta}
  {\Gamma,\Sigma\infers e_1 :: e_2 : \text{List } \beta}

\newrule{T-ListHead}
  {\Gamma,\Sigma\infers e:\text{List }\beta}
  {\Gamma,\Sigma\infers \text{head}\ e:\beta}

\newrule{T-ListTail}
    {\Gamma,\Sigma\infers e:\text{List }\beta}
    {\Gamma,\Sigma\infers \text{tail}\ e:\text{List }\beta}
...
\newrule{E-Head}
  ...
  {\text{head } e,\sigma\bar{\eval}\bar{v_1},\bar{\sigma'}}

\newrule{E-Tail}
{e,\sigma\bar{\eval} \bar{v_1}::\bar{v_2},\bar{\sigma'}}
{\text{head } e,\sigma\bar{\eval}\bar{v_2},\bar{\sigma'}}
