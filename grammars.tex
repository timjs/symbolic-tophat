...
\newmacro{G-Language-Compact}{
  \begin{grammar}
    ...
    \addlinespace
    & u &::= &  \lnot \Mid - \Mid \# \Mid \Uniq                    & – not, negate, length, unique \\
    \\
...
\newmacro{G-Values-Compact}{
  \begin{grammar}
    ...
    \addlinespace
      ...
      &   & \mid & \highlight{$s \Mid u\ v \Mid v_1\ o\ v_2$}               & – symbol, unary op, binary op\\
  \end{grammar}
}
...
\newmacro{G-Inputs-Compact}{
  \begin{grammar}
    ...
    \addlinespace
      & i    & ::=& \highlight{$s$} \Mid \First i \Mid \Second i  & – symbolic action, to first, to second
  \end{grammar}
}
