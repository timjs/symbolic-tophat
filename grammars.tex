...
\newmacro{G-Language-Compact}{
  \begin{grammar}
    ...
    & u &::= &  \lnot \Mid - \Mid \#                         & - logical, numerical, sequential\\
    \\
...
\newmacro{G-Values-Compact}{
  \begin{grammar}
    \noalign{Values}\\
      ...
      &   & \mid & s \Mid u\ v \Mid v_1\ o\ v_2                      & – symbol, unary op, binary op\\
  \end{grammar}
}
...
\newmacro{G-CInputs-Compact}{
  \begin{grammar}
    \noalign{Concrete inputs}\\
      & j    & ::=& \bar{a} \Mid \First j \Mid \Second j             & – action, to first, to second \\
      &      &\mid& \First j             & – pass to first \\
      &      &\mid& \Second j            & – pass to second \\
      \\
