...
\newmacro{G-Values-Compact}{
  \begin{grammar}
    ...
    \addlinespace
      ...
      &   & \mid & [\ ]_\beta \Mid v_1 :: v_2                          & - nil, cons\\
      &   & \mid & c \Mid l \Mid t \Mid \highlight{s}                  & – constant, location, task, symbol \\
      &   & \mid & \highlight{u\ v \Mid v_1\ o\ v_2}                   & – symbolic unary/binary operation\\
  \end{grammar}
}
