...
\newmacro{G-Types-Compact}{
  \begin{grammar}
    \noalign{Types}\\
      ...
      \\
    \noalign{Basic types}\\
      & \beta &  ::= & \tau_1 \times \tau_2 \Mid [\ ]_\beta         & - product, list\\
      &       & \mid & \Unit \Mid \Bool                           & – unit, boolean\\
...
\newmacro{G-Values-Compact}{
  \begin{grammar}
    \noalign{Values}\\
      ...
      &   & \mid & [\ ]_\beta \Mid v_1 :: v_2                          & - empty list, cons\\
      &   & \mid & c \Mid l \Mid t                                     & – constant, location, task \\
      &   & \mid & \colorbox{lightgray}{$s \Mid u\ v \Mid v_1\ o\ v_2$}               & – symbol, unary op, binary op\\
  \end{grammar}
}
...
\newmacro{G-Inputs-Compact}{
  \begin{grammar}
    \noalign{Symbolic inputs}\\
      & i    & ::=& \colorbox{lightgray}{$s$} \Mid \First i \Mid \Second i  & – symbolic action, to first, to second
  \end{grammar}
}
