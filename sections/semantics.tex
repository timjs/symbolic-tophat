...
\begin{figure*}
  \begin{function}
    \signature{\mathit{simulate} : \mathrm{Task} \times \mathrm{State} \times [\mathrm{Input}]  \times \mathrm{Predicate}
      \rightarrow \powerset{\mathrm{Value} \times [\mathrm{Input}] \times \mathrm{Predicate}}} \\
    \mathit{simulate}(t, \sigma, I, \phi) &=&
      \bigcup \set{ \mathit{simulate'}(\True, t, I, \phi, t', \sigma', i', \phi') \mid t, \sigma \drive{} t', \sigma', i', \phi' } \\
    \addlinespace
    \signature{\mathit{simulate'} : \mathrm{Bool} \times \mathrm{Task} \times [\mathrm{Input}] \times \mathrm{Predicate} \times \mathrm{Task} \times \mathrm{State} \times \mathrm{Input} \times \mathrm{Predicate}
      \rightarrow \powerset{\mathrm{Value} \times [\mathrm{Input}] \times \mathrm{Predicate}}} \\
