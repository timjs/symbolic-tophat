...
\begin{function}
  \signature{\Rrightarrow :: \Task \times \mathrm{State} \rightarrow [(\Task,\mathrm{State},[\mathrm{Inputs}],\mathrm{Predicate})]} \\
  \Rrightarrow\ t\ \sigma = \{(t',\sigma',\phi,i)\mid t,\sigma\drive{i}t',\sigma',\phi\ , \ i\in\Inputs(t,\sigma)\}
\end{function}
...
\begin{function}
  ...
  \mathit{drive}\ t\ I\ \sigma \ \phi  = \mathit{map} \ (\mathit{concat . drive'}) (\Rrightarrow\ t\ \sigma)\\
