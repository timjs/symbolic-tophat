...
\begin{figure*}[t]
  \begin{function}
    ...
    \Simulate\ (t, \sigma, I, \phi) &=&
      \bigcup \set{ \Simulate'\ (\True, t, t', \sigma', I\oplus[i'], \phi\land\phi') \mid t, \sigma \interact{} t', \sigma', i', \phi' } \\
    \addlinespace
      ...
      \multicolumn{3}{L}{ \left\{
        \begin{array}{lr@{\ }c@{\ }l@{\ }c@{\ }l@{\ }c@{\ }r}
          ...
          \bigcup \set{\Simulate'\ (\False, t', t'', \sigma'', I\oplus[i'], \phi\land\phi')
            \mid  t',\sigma' \siminteract t'', \sigma'', i', \phi'}                                       & \Sat(\phi)     &\land& \Value(t',\sigma') = \bot &\land& t' = t    &\land& \Again\\
