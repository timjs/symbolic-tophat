...
\Cref{fig:thetaxman} shows an example program, based on \cite{conf/sfp/StutterheimAP17}
...
\begin{TASK}
  ...
  provideCitizenInformation = enter <<BSN, Address, Date>>
  provideDocuments = enter <<Amount, Date>>
  companyApprove = edit True <?> edit False
  officerApprove = invoiceAmount invoiceDate today cApproved =
      edit False <?> if (today - invoiceDate < 365 && cApproved)
