...
\case{$e=\Fst e$}
{
  One rule applies, namely \userule{Sym-E-First}\\
  Provided that $M\phi$,
...
\case{$e=\Snd e$}
{ One rule applies, namely \userule{Sym-E-Second}\\
  Provided that $M\phi$,
...
\case{$e=e_1::e_2$}
  {One rule applies, namely \userule{Sym-E-Cons}\\
  Provided that $M\phi$,
...
\case{$e=\Head e$}
  {One rule applies, namely \userule{Sym-E-Head}\\
  Provided that $M\phi$,
...
\case{$e=\Tail e$}
  {One rule applies, namely \userule{Sym-E-Tail}\\
    Provided that $M\phi$,
...
\case{$e=\If{e_1}{e_2}{e_3}$}
   {One rule applies, namely \userule{Sym-E-If}\\
...
\begin{proof}[Proof of Lemma~\ref{lem:soundhandle}]
  ...
  \case{$t=e_1\Or e_2$}
  {One rule applies, namely \userule{Sym-H-Or}\\
