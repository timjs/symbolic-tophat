...
\begin{proof}
  ...
  \case{\refrule{SS-ThenCont}}
    ...
    Since $M$ satisfies both $\phi_1$ and $\phi_2$,
    we obtain from \refrule{S-ThenCont}, the induction step and application of Lemma~\ref{lem:soundeval} above that
    $t_1\Then e_2,\sigma\stride t_2,\sigma''$ with
    $M \simt_2 \equiv t_2$ and $M\sims''\equiv {\sigma''}$.
    }
...
\begin{proof}
  ...
  $M \simt_1'\Then e_2\equiv {t_1'}\Then e_2$ and $M\sims'\equiv{\sigma'}$.
    ...
    Since $M$ satisfies $\phi_1$, we obtain from \refrule{H-PickLeft} and the application of Lemma~\ref{lem:soundnorm} above that $e_1\Xor e_2,\sigma\handle{\Left}t_1,\sigma'$ with
    $M \simt_1\equiv {t_1}$ and $M\sims'\equiv {\sigma'}$.
    }
    ...
    Since $M$ satisfies $\phi_2$, we obtain from \refrule{H-PickRight} and the application of Lemma~\ref{lem:soundnorm} above that $e_1\Xor e_2,\sigma\handle{\Right}t_2,\sigma'$ with
    $M \simt_2\equiv {t_2}$ and $M\sims_2\equiv {\sigma'}$.
    }
