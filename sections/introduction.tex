...
\fixme{Consistent use of ref and cref, Fig., Figure, and so on}
...
\Cref{sec:intuition} describes the intuition behind symbolic execution and how it is applied to \TOPHAT.
\Cref{sec:examples} will give a brief overview of \TOPHAT and introduce some examples to demonstrate the goal of our analysis.
