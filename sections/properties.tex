...
\todo{update theorem}
  ...
  such that $t,\sigma\interact{} \overline{t',\sigma',i,\phi}$
...
\todo{update this lemma}
  For all tasks $t$, states $\sigma$ and mappings $M = [s_0\mapsto c_0,\cdots,s_n\mapsto c_n]$,
  such that $t,\sigma\interact{i} \overline{t',\sigma',\phi}$,
  we have $M\phi$ implies
...
\begin{theorem}[Completeness of driving]
  \label{thm:completeDrive} \todo{update theorem}
  For all $t,\sigma,j$ such that $t,\sigma \xRightarrow[]{j} \hat{t'},\hat{\sigma'}$
  there exists an $i\sim j$ such that $t,\sigma''\interact{} t'',\sigma''',i,\phi$.
\end{theorem}
...
\begin{lemma}[Completeness of handling]
  \label{lem:completeHandle} \todo{update lemma}
  For all $t,\sigma,j$ such that $t,\sigma \xrightarrow[]{j} \hat{t'},\hat{\sigma'}$
...
\begin{lemma}[Completeness of normalisation]
  \label{lem:completeNormalise}\todo{update lemma}
...
\begin{lemma}[Completeness of evaluation]
  \label{lem:completeEval}\todo{update lemma}
