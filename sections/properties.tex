...
The proofs of \cref{lem:completeNormalise,lem:completeStride,lem:completeEval} are trivial, since every concrete execution in these semantics is also a symbolic one.\todo{maybe just inline the proofs since they are only one line long?}
