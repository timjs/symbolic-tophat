...
\begin{proof}
  ...
  {In this case, two rules apply.\\
    \case{\userule{Sym-H-Next}}
      {Provided that $M\True$ and \userule{H-Next} with $\bar{\sigma}=M\sigma$,
  ...
  {
  In this case, two rules apply.\\
    \case{\userule{Sym-H-PickLeft}}{\fixme{todo}}
    \case{\userule{Sym-H-PickRight}}{\fixme{todo}}
  }

  \case{$t=e_1\And e_2$}
  {
  In this case, two rules apply.\\
    \case{\userule{Sym-H-FirstAnd}}{\fixme{todo}}
    \case{\userule{Sym-H-SecondAnd}}{\fixme{todo}}
  }

  \case{$t=e_1\Or e_2$}
  {
  In this case, two rules apply.\\
    \case{\userule{Sym-H-FirstOr}}{\fixme{todo}}
    \case{\userule{Sym-H-SecondOr}}{\fixme{todo}}
  }
\end{proof}
